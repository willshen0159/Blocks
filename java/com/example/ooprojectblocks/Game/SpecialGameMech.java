...
public class SpecialGameMech extends GameMech {
    ...
    public SpecialGameMech(String player1, String player2, boolean bgm, boolean sound, boolean colorBlind, ConstraintLayout layout, Activity activity) {
        this.sound = sound;
        ...
        this.player1 = new Hero(width / 2 - width / 40, height - (width / 3), width / 20, width / 20, "red");
